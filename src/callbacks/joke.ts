...
const jokes = [
  ...
  ["Halloween jokes that'll have everyone howling"],
  ["Thanksgiving jokes for kids and adults"],
  ["Christmas jokes to keep the spirits bright"],
  ["Father's Day jokes to show you got dad's funny bone"],
];
